      ...
      <div class="card">
          ...
          <div class="card-body">
              ...
              <select name="department" v-model="student.department" class="form-control">
               ...
               <small style="color:red" v-if="errors && errors.department">{{errors.department}}</small>
          </div>
...
export default {
  ...
  methods: {
      updateStudent(){
        ...
        if (this.student.name && this.student.roll && this.student.reg && this.student.department) {
          ...
          this.axios.post(`update_student/${this.$route.params.id}`,this.student).then((response)=>{
            this.$router.push('/');
  ...
  mounted() {
    this.axios.get("student/"+this.$route.params.id).then((response) => {
        this.student.name = response.data.students.name
        this.student.roll = response.data.students.roll
        this.student.reg = response.data.students.reg
        this.student.department = response.data.students.department
